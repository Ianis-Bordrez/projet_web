$(document).ready(function(){
    ...
    function make_chat_dialog_box(receiver_id, receiver_username) {
        ...
        modal_content += '<div style="height:400px; border:1px solid #ccc; overflow-y: scroll; margin-bottom:24px; padding:16px;" class="chat_history bg-darkblue txt-grey" data-receiverid="'+receiver_id+'" id="chat_history_'+receiver_id+'">';
        modal_content += fetch_user_chat_history(receiver_id);
        modal_content += '</div>';
        modal_content += '<div class="form-group">';
        modal_content += '<textarea name="message_'+receiver_id+'" id="message_'+receiver_id+'" class="form-control bg-darkblue txt-white"></textarea>';
